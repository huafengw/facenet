...
# Modifiy resnet v1 to also output feature from last global pool layer 
    ...
    with tf.variable_scope(scope, 'resnet_v1', [inputs], reuse=reuse) as sc:
        ...
        with slim.arg_scope([slim.conv2d, bottleneck,
            ...
            with slim.arg_scope([slim.batch_norm], is_training=is_training):
                ...
                if global_pool:
                    end_points['global_pool'] = out_global_pool
...
def resnet_v1_triplet(inputs,
    ...
    Args:
      ...
      reuse: whether or not the network and its variables should be reused. To be
        able to reuse 'scope' must be given.
      scope: Optional variable_scope.
      embedding_size: The output feature embedding size.
...
def resnet_v1_101_triplet(inputs,
                          num_classes=None,
                          is_training=True,
                          global_pool=True,
                          output_stride=None,
    ...
    return resnet_v1_triplet(inputs, blocks, num_classes, is_training,
                     global_pool=global_pool, output_stride=output_stride,
                     include_root_block=True, reuse=reuse, scope=scope, embedding_size=embedding_size)


resnet_v1_101_triplet.default_image_size = 224
